:Title: OGC Name Type Specification - Sensor Models and Parameters
:titletext: OGC Name Type Specification - Sensor Models and Parameters
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/TBA
|Internal reference number of this OGC(R) document:    18-042r1
|Version: 1.0
...
This document defines a DRAFT OGC Policy. It is subject to change without notice. This document is an [underline]#official position# of the OGC membership on this particular topic.
...
include::clause_7_name_assignment_policy.adoc[]

include::clause_8_examples.adoc[]
