:Title: OGC Naming Authority - Procedures
:titletext: OGC Naming Authority - Procedures
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/POL/OGC-NA/1.2
|Internal reference number of this OGC(R) document:    09-046r5
|Version: 1.2
|Category: OGC® Policy
...
This document is not OGC Policy. This document is distributed for review and comment. This document is subject to change without notice and may not be referred to as OGC Policy.
...
include::clause_6_naming_rule.adoc[]

include::clause_7_name_registration.adoc[]

include::clause_8_ogc_urn_resolver.adoc[]

include::clause_9_historical_note.adoc[]
