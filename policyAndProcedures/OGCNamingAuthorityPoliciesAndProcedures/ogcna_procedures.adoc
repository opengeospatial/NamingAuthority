...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/POL/OGC-NA/2.0
|Internal reference number of this OGC(R) document:    09-046r2
|Version: 2.0
...
This document defines an OGC Policy. It is subject to change without notice. This document is an [underline]#official position# of the OGC membership on this particular topic.
