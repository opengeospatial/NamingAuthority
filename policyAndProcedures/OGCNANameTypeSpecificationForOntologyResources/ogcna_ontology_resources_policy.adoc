:Title: OGC Name Type Specification - ontology resources
:titletext: OGC Name Type Specification - ontology resources
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/pol-nts/ont/2.0
|Internal reference number of this OGC(R) document:    12-081
|Version: 2.0
