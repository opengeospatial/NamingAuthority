...
The OGC-NA maintains a register for link relation types at https://www.opengis.net/def/rel.
...
The OGC-NA maintains a register for media types at https://www.opengis.net/def/media-type.
