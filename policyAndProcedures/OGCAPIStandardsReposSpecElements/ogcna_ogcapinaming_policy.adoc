:Title: Naming of OGC API Standards, Repositories & Specification Elements
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/pol/ogcapi-naming/1.0
|Internal reference number of this OGC(R) document:    20-059r4
|Version: 1.0
...
include::clause_6_normative.adoc[]
