...
:titletext: OGC Name Type Specification - definitions - part 1 – basic name
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/POL-NTS/DEF-1/1.1
|Internal reference number of this OGC(R) document:    09-048r3
|Version: 2.0
