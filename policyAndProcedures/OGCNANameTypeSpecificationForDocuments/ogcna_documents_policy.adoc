:Title: OGC Name Type Specification - documents
:titletext: OGC Name Type Specification - documents
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document:  http://www.opengis.net/doc/POL-NTS/DOC/2.0
|Internal reference number of this OGC(R) document:    09-047r4
|Version: 2.0
