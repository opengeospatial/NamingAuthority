:Title: OGC Name Type Specification - specification elements
:titletext: OGC Name Type Specification - specification elements
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/POL-NTS/SPEC/3.0
|Internal reference number of this OGC(R) document:    10-103
|Version: 3.0
