...
other_qres = h.query(other_query)
for other_row in other_qres:
    if not(str(other_row.s) in v5_identifiers):
        v5_identifiers.append(str(other_row.s))
        #print(f"{other_row.s} prefLabel {other_row.o}")
