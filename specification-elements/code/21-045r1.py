...
# 21-045r1: OGC Features and Geometries JSON - Part 1: Core (JSON-FG)
# https://github.com/opengeospatial/ogc-feat-geo-json/tree/main/core

### Target document URL
specURL = "https://docs.ogc.org/is/21-045r1/21-045r1.html"

### Base Namespace URI (No trailing slash)
baseNSURI = "http://www.opengis.net/spec/json-fg-1/1.0"
