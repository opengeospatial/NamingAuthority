...
specURL = "http://docs.opengeospatial.org/is/17-069r4/17-069r4.html"
fout = open("../mappings/17-069r4.csv","w")  # output file
fin = open("../specifications/17-069r4.html","r") # input file
elementList = []
