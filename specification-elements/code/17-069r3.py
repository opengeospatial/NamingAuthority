...
def cleanString(intext):
    ...
    if intext.startswith("/req/") or intext.startswith("/conf/") or intext.startswith("/rec/") or intext.startswith("/per/") or intext.startswith("/ats/"):
        intext = "http://www.opengis.net/spec/ogcapi-features-1/1.0"+intext
    return intext

specURL = "http://docs.opengeospatial.org/is/17-069r3/17-069r3.html"
fout = open("../mappings/17-069r3.csv","w")  # output file
fin = open("../specifications/17-069r3.html","r") # input file
elementList = []
